...
import 'package:mcorses/pages/others/hist_admin_formation.dart';

List<MyUser> admins = [];
late Formation formation;

class AdminListFormation extends StatefulWidget {
  final Formation formation;
  const AdminListFormation({Key? key, required this.formation})
      : super(key: key);

  @override
  _AdminListFormationState createState() => _AdminListFormationState();
}

class _AdminListFormationState extends State<AdminListFormation> {
  bool loading = false;
  ...
  getAdmins() async {
    ...
    var url = "$serverDir/GET_ADMINS_FORMATION.php";
    print("url=$url");
    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: AppBar(
                ...
                centerTitle: true,
                titleSpacing: 0,
                title: const Center(child: Text("Liste des Administrateurs")),
                actions: [
                  IconButton(
                      onPressed: () {
                        var route = MaterialPageRoute(
                            builder: (context) =>
                                HistAdminFormation(idFormation: formation.id));
    ...
    return Padding(
        ...
        child: Column(children: [
          ...
          SizedBox(
              ...
              child: Text(admins.length.toString() + " Administrateur$s",
